...
/**
 * 
 * This class has Specialization sending SMS
 * 
 * @author Rahil
 *
 */
@Slf4j
@Service
public class SMSChannelService extends ChannelService {

	@Override
	protected Status sendAtChannel() {
		log.info("Sending SMS message to " + this.sendMessageTO.getContactID());
		this.setChannel("SMS");

...
import com.rs4u.ticketbooking.repositories.UserTransactionRepository;

@RunWith(SpringRunner.class)
public class FaceBookChannelServiceTest {
	@TestConfiguration
	static class ContactServiceImplTestContextConfiguration {

		@Bean
		public ChannelService facebookChannelService() {
			return new FaceBookChannelService();
		}
